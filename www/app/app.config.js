angular.module('Inventario').constant('rolAdmin', 1);
angular.module('Inventario').constant('rolCelador', 2);

/**
 * middleware que comprueba las session y los tipos de roles
 */
angular.module('Inventario').config(['$middlewareProvider', function middlewareProviderConfig($middlewareProvider) {
...
angular.module('Inventario').config(['$routeProvider', '$httpProvider', function config($routeProvider, $httpProvider) {
