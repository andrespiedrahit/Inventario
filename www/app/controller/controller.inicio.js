angular.module('Inventario').controller('inicioController', ['$scope', 'registroUsuarioService', '$sessionStorage', '$location', 'rolAdmin', '$route', '$timeout', function ($scope, agregarUsuario, $sessionStorage, $location, rolAdmin, $route, $timeout) {
        ...
        $scope.editarArt = function (dato) {
            $scope.editArt.id = dato.inv_id;
            $scope.editArt.codigo = dato.inv_codigo;
            $scope.editArt.nombre = dato.inv_nombre;
            $scope.editArt.descripcion = dato.inv_descripcion;
            $scope.editArt.cantida=dato.inv_cantida;
        ...
        $scope.eliminarArt = function (dato) {
            ...
            $scope.nombre = dato.inv_nombre;
            $scope.ideliminar = dato.inv_id;
        };
